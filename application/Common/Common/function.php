...
/**
 * 使用一个表中的数据制作下拉框
 * @param table $tableName        //要显示数据的来源表
 * @param string $selectName      //显示数据的字段
 * @param string $valueFieldName  //显示数据的对应数据表的值
 * @param string $textFieldName   //显示的数据
 * @param string $selectedValue   //被选择的值
