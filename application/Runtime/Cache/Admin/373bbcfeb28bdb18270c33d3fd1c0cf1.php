...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="/SHOP/admin.php/Goods/lst.html" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="/SHOP/admin.php/Goods/add.html" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="categoryList.html" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="/SHOP/admin.php/Brand/lst.html" target="main-frame">商品品牌</a></li>
            ...
            会员管理
                <ul>
                    <li class="menu-item"><a href="/SHOP/admin.php/MemberLevel/lst.html" target="main-frame">会员列表</a></li>
                    <li class="menu-item"><a href="/SHOP/admin.php/MemberLevel/add.html" target="main-frame">添加会员</a></li>
