...
<div class="main-div">
    <form name="main_form" method="POST" action="/SHOP/index.php/Admin/Attribute/add/type_id/3.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea rows="5" cols="60" name="attr_option_values" ></textarea>
                </td>
            </tr>
            <tr>
